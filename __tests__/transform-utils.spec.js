...
const $updateEventRaw = {
  document: 'tenants/000000000001',
  data: [
    10, 151, 1, 10, 76, 112, 114, 111, 106, 101, 99, 116, 115, 47, 121, 117,
    110, 105, 98, 97, 115, 45, 112, 114, 109, 115, 45, 100, 101, 118, 47, 100,
    97, 116, 97, 98, 97, 115, 101, 115, 47, 40, 100, 101, 102, 97, 117, 108,
    116, 41, 47, 100, 111, 99, 117, 109, 101, 110, 116, 115, 47, 116, 101, 110,
    97, 110, 116, 115, 47, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 49, 18,
    21, 10, 2, 105, 100, 18, 15, 138, 1, 12, 48, 48, 48, 48, 48, 48, 48, 48, 48,
    48, 48, 49, 18, 20, 10, 4, 110, 97, 109, 101, 18, 12, 138, 1, 9, 65, 67, 77,
    69, 44, 32, 73, 110, 99, 26, 12, 8, 238, 159, 242, 171, 6, 16, 152, 215,
    252, 206, 3, 34, 12, 8, 179, 206, 242, 171, 6, 16, 152, 139, 138, 183, 3,
    18, 151, 1, 10, 76, 112, 114, 111, 106, 101, 99, 116, 115, 47, 121, 117,
    110, 105, 98, 97, 115, 45, 112, 114, 109, 115, 45, 100, 101, 118, 47, 100,
    97, 116, 97, 98, 97, 115, 101, 115, 47, 40, 100, 101, 102, 97, 117, 108,
    116, 41, 47, 100, 111, 99, 117, 109, 101, 110, 116, 115, 47, 116, 101, 110,
    97, 110, 116, 115, 47, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 49, 18,
    21, 10, 2, 105, 100, 18, 15, 138, 1, 12, 48, 48, 48, 48, 48, 48, 48, 48, 48,
    48, 48, 49, 18, 20, 10, 4, 110, 97, 109, 101, 18, 12, 138, 1, 9, 65, 67, 77,
    69, 44, 32, 76, 76, 67, 26, 12, 8, 238, 159, 242, 171, 6, 16, 152, 215, 252,
    206, 3, 34, 12, 8, 139, 198, 242, 171, 6, 16, 240, 232, 221, 154, 2, 26, 6,
    10, 4, 110, 97, 109, 101,
  ],
}
const $addEventRaw = {
  ...
  data: [
    ...
    116, 41, 47, 100, 111, 99, 117, 109, 101, 110, 116, 115, 47, 116, 101, 110,
    97, 110, 116, 115, 47, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 49, 18,
    19, 10, 4, 110, 97, 109, 101, 18, 11, 138, 1, 8, 65, 67, 77, 69, 32, 73,
    110, 99, 18, 21, 10, 2, 105, 100, 18, 15, 138, 1, 12, 48, 48, 48, 48, 48,
    48, 48, 48, 48, 48, 48, 49, 26, 12, 8, 238, 159, 242, 171, 6, 16, 152, 215,
    252, 206, 3, 34, 12, 8, 238, 159, 242, 171, 6, 16, 152, 215, 252, 206, 3,
  ],
}

describe('Testing Transformation Utils', () => {
  test('should encode firestore event', async () => {
    const result = await $transform.encodeFirestoreEvent($updateEventObject)
    expect(result).toBeTruthy()
  })

  test('should decode encoded firestore event', async () => {
    const result = await $transform.decodeFirestoreEvent($updateEventRaw)
    expect(result).toBeTruthy()
  ...
  test('should decode firestore create event', async () => {
    const result = await $transform.decodeFirestoreEvent($addEventRaw)
  ...
  test('should not find a diff', async () => {
    const result = await $transform.parseUpdateDiff(
      $updateEventObject.data.oldValue.fields,
      $updateEventObject.data.value.fields,
